...
export LD_LIBRARY_PATH="/home/aayushrd7/aarch64-linux-android-4.9-kernel/x86_64-linux-gnu/aarch64-linux-android/lib"
export CROSS_COMPILE="/home/aayushrd7/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-"
export ARCH=arm64
export SUBARCH=arm64
export KBUILD_BUILD_USER="AayushRd7"
export KBUILD_BUILD_HOST="XeSki-PoWeR"
STRIP="/home/aayushrd7/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-strip"
...
cd $OUT_DIR
zip -r XeskiKernel_UBTC-v1.0.zip *
cd $KERNEL_DIR
BUILD_END=$(date +"%s")
